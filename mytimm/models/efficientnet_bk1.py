...
class EfficientNet(nn.Module):
    ...
    def get_pruned_module(self, module_list, prune_checkpoints, prune_block_nums):
    ...
    def forward(self, x, subnet):
        ...
        return self.classifier(x), features, feature_idxs
