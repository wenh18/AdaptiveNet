...
# NOTE: By default, any modules from mytimm.models.layers that we want to treat as leaf modules go here
# BUT modules from mytimm.models should use the registration mechanism below
_leaf_modules = {
