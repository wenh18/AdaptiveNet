...
# Modified from
# https://github.com/rwightman/pytorch-image-models/blob/master/mytimm/models/vision_transformer.py
...
from mytimm.data import IMAGENET_DEFAULT_STD, IMAGENET_DEFAULT_MEAN
