...
at https://github.com/google-research/big_transfer to match mytimm interfaces. The BiT weights have
...
from mytimm.data import IMAGENET_INCEPTION_MEAN, IMAGENET_INCEPTION_STD
