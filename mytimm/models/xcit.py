...
def checkpoint_filter_fn(state_dict, model):
    ...
    # For consistency with mytimm's transformer models while being compatible with official weights source we rename
    ...
    for k in pos_embed_keys:
        if use_pos_embed:
            ...
            del state_dict[k]
    # mytimm's implementation of class attention in CaiT is slightly more efficient as it does not compute query vectors
