...
parser.add_argument('--backbonepath', metavar='DIR', help='path to dataset')
parser.add_argument('--headpath', metavar='DIR', help='path to dataset')
parser.add_argument("--stage", default=0, type=int)
parser.add_argument('--distillhead', action='store_true', default=False)
parser.add_argument('--distilledmodel', metavar='DIR', help='path to dataset')
...
def main():
    ...
    if args.stage == 0:
        ...
        model.model.load_state_dict(torch.load(args.distilledmodel), strict=True)
    ...
    try:
        for epoch in range(start_epoch, num_epochs):
            ...
            name = "multisubnet/distilled_model/notdistillcoco" + str(epoch) + ".pth"  # + "loss" + str(int(train_metrics['loss'] * 1000)) + ".pth"
